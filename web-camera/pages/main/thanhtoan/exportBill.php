<?php
    ...
    $kn = mysqli_connect('localhost','root','','web_camera');
        if(!$kn){
    			...
    			<div class="receipt-header">
					...
					<div class="col-xs-6 col-sm-6 col-md-6 text-right">
						<div class="receipt-right">
							...
							<p>0987643298<i class="fa fa-phone"></i></p>
							<p>Huynam3010@gmail.com <i class="fa fa-envelope-o"></i></p>
			...
			<div class="row">
				<div class="receipt-header receipt-header-mid">
					<div class="col-xs-8 col-sm-8 col-md-8 text-left">
						<div class="receipt-right">
							<h5>Name: '.$row_ship[1].' </h5>
							<p><b>Mobile : </b> '.$row_ship[4].'</p>
							<p><b>Email : </b>'.$row_ship[5].'</p>
							<p><b>Address : </b>'.$row_ship[6].'</p>
						</div>
					</div>
